                ...
                {this.props.intervention.map((oneIntervention, i) => {
                    ...
                    return (
                        <Card style={{ padding: "10px" }} key={i}>
                            ...
                            <div style={{ fontWeight: "bold" }}>{oneIntervention.title}{/* ({oneIntervention.date}) */}</div>
                            ...
                            <div style={{ display: "flex", justifyContent: "center" }}>
                                <button style={{ padding: "10px", borderRadius: "50px", backgroundColor: "#FA8181", border: "0px", marginTop: "35px", color: "white", boxShadow: "5px 5px 2px 1px rgba(0, 0, 255, .2)" }} onClick={() => this.removeFromList(oneIntervention._id, oneIntervention.update)}>Supprimer de la liste</button>
                            </div>
                        </Card>
                    )
                })}
